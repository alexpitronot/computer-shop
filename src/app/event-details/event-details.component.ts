...
export class EventDetailsComponent implements OnInit {
  ...
  events = [
    {name: 'New Asus presentation', date: '3/1/2022', time: '10:00', location: {street: '23 Burla St', city: 'Haifa', country: 'Israel'}, registration : true, label: 'public'},
    ...
    {name: 'Intel experience', date: '1/18/2022', location: {street: '12 Lilach St', city: 'Tel-Aviv', country: 'Israel'}, registration : false},
    ...
    {name: 'G6 new mpdel', date: '1/5/2022', time: '10:00', registration : false, label: 'new'}
  ]
